...
Next, we analyse and describe the taxonomic composition within the *trans* and control groups by sexual activity. There are no significant statistical differences and the sample size is small. Therefore, the top 10 abundant taxa are listed for sexually active and non-active subgroups:

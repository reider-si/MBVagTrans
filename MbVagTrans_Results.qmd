...
genus_SexOfPartner2  = Maaslin2(input_data = otu_table(ps_rel_genus_sexuallyactive),
         ...
         min_prevalence = 0.2,
         max_significance = 0.2,
         fixed_effects = c("SexOfPartner", "grp"))
...
ggsave(maaslin_res_genus_sexpartner, filename = "results/maaslin2/genus_SexOfPartner_panelplot.png",
       height = 5, width = 6)
